...
function threeN(){
    ...
    <span class="sep">/</span> \
    <span class="dois">' + texto3 + '<span class="wa"> <span class="botao">' + icon + 'Whatsapp' + seta + '<span class="texto"><a class="linkDaBarra" target="_blank" href="https://api.whatsapp.com/send?phone=' + numLink3 + '&text=' + mensagem3 + '">' + numero3 + '</a></span></span>\
